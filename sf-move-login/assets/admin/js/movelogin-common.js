/* globals jQuery: false, wp: false, MoveLogini18nCommon: false, secupressNotices: true, swal: false */
		...
		html  = '<div class="secupress-response-notice secupress-rn-' + merged.type + ' secupress-flex">';
			...
			html += '<div class="secupress-rn-actions">';
				html += '<button type="button" class="secupress-rn-close secupress-virgin">';
					...
					html += '<span class="screen-reader-text">' + MoveLogini18nCommon.closeText + '</span>';
				html += '</button>';
			html += '</div>';
		html += '</div>';
