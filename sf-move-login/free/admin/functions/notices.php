 ...
 * @param (null|string) $capa       A WordPress capability or role. "null" = movelogin_get_capability()
 */
function movelogin_add_notice( $message, $error_code = 'updated', $notice_id = '', $capa = null ) {
 ...
 * @param (null|string) $capa       A WordPress capability or role. "null" = movelogin_get_capability()
 */
function movelogin_add_transient_notice( $message, $error_code = 'updated', $notice_id = '', $capa = null ) {
 ...
 */
function movelogin_dismiss_notice( $notice_id, $user_id = 0 ) {
 ...
 * @return (bool) true on success.
 */
function movelogin_reinit_notice( $notice_id, $user_id = 0 ) {
 ...
 */
function movelogin_notice_is_dismissed( $notice_id ) {
