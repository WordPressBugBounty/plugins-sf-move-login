...
add_action( 'wp', 'movelogin_late_robots_check' );
/**
 ...
 * @return (void)
 **/
function movelogin_late_robots_check() {
    add_filter( 'wp_robots', 'wp_robots_noindex_embeds' );
    add_filter( 'wp_robots', 'wp_robots_noindex_search' );
}

add_filter( 'doing_it_wrong_trigger_error', 'movelogin_remove_fking_warning_from_wp67', 10, 2 );
/**
 ...
 * @return (bool)
 **/
function movelogin_remove_fking_warning_from_wp67( $bool, $function_name ) {
